...
\begin{itemize}
    ...
    \item \textbf{Explainable Boosting Machines} $\leftarrow$ GAM + Gradient Boosting + Tree ensembles \furtherreading{Lou_2012}\\$\leadsto$ More intelligible than unrestricted full complexity models (e.g. random forest) + High accuracy close to unrestricted full complexity models
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \item In the next step: \furtherreading{Lou_2013}
    \begin{itemize}
