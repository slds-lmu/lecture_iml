...
% 			Functional ANOVA decomposition for \textbf{independent features} \furtherreading{Hooker_2004} \\
...
% 			\item Generalized functional ANOVA decomposition for \textbf{dependent features} \furtherreading{Hooker_2007} \\
...
% 			% Variance decomposition only with covariance component \furtherreading{Chastaing_2012}
% 			\item Accumulated local effect (ALE) decomposition (via finite differences) \furtherreading{Apley_2020}
% 		\end{itemize}
