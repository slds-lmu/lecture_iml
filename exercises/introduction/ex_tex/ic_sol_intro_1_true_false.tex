...
%        \end{itemize}
      ...
      \item As models capture increasingly complex (higher-order) feature interactions, they become more difficult to interpret.
        \begin{itemize}
      		\item[$\Rightarrow$] \textbf{Correct}. When we add interaction terms to a linear model or allow a decision tree to split further, it becomes harder to interpret the model, e.g., via visualizations or by interpreting coefficients. 
     	\end{itemize}
