...
\item\label{MI_Aufgabe_2}
In exercise \ref{MI_Aufgabe}), find a way to work around the problem encountered and calculate the MI between $x_1$ and $x_2$. Interpret the result and compare it with your previous findings.
