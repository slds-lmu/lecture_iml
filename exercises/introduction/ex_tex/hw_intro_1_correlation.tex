...
\textit{For further reading on mutual information, see:}\\
\url{https://slds-lmu.github.io/i2ml/chapters/13_information_theory/13-07-mutual-info/}\\
\url{https://slds-lmu.github.io/i2ml/chapters/13_information_theory/13-08-mutual-info2/}

\item Based on your findings in parts a)--c), what is the overall lesson about using Pearson correlation as a measure of dependency?
...
\textit{Hint:} Consider discretizing the continuous features into bins to approximate the probability distributions.
