...
\url{https://statproofbook.github.io/P/slr-rsq.html} (proof of $R^2 = \rho^2$ for simple linear regression)\\
\url{https://math.stackexchange.com/questions/129909/correlation-coefficient-and-determination-coefficient} (discussion of correlation and determination coefficients)
