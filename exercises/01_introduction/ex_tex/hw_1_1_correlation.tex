...
\bonusaufgabeFootnote{

In exercise 1\ref{MI_Aufgabe}), find a way to work around the problem encountered, then calculate the MI between $x_1$ and $x_2$, and interpret the result and compare it with your previous findings.
