...
\item We now want to consider the mutual information (MI) instead of the Pearson correlation coefficient in the above example.
...
What problem do you encounter when using this formula to calculate the mutual information between $x_1$ and $x_2$? Decide on a way to work around this problem and calculate the MI between $x_1$ and $x_2$.

Interpret the result and compare it with your previous findings.
