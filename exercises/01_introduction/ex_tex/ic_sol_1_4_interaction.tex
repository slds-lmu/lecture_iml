...
Problem: The function $	f(\bold{x}) = 2 x_1 + 3 x_2 - x_1 |x_2|$ is not differentiable for $x_2 = 0$. Hence, different cases need to be considered:
\begin{center}
	Case 1: $x_2 > 0$ \\
	Case 2: $x_2 < 0$ \\
	Case 3: $x_2 = 0$
...
Case 1: $x_2 > 0$
\begin{align*}
	\left( \frac{\partial^2 f(\bold{x})}{\partial x_1 \partial x_2} \right)^2 
