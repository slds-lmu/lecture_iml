\loesung{\textbf{LIME: Example}
\begin{enumerate}[a)]
  \item  Filled out table:
  
    \textit{TO DO: Are these correct? Students reported 0.60 and 0.52, TO CHECK}
    % \textit{TO DO: Are these correct? Could be wrong, TO CHECK}
  ...
  \begin{itemize}
    ...
    \item Since there are not many data points used to fit the surrogate model, the model might be unstable
