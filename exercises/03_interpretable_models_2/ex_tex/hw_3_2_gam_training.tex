...
\begin{itemize}
    ...
    \item 
    When working with R, the package \texttt{mgcv} contains the \href{https://www.rdocumentation.org/packages/stats/versions/3.6.2/topics/glm}{gam} function. Also, the package \texttt{gam} can be used.
\end{itemize}
