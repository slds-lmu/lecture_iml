...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Which features are (mechanistically) used by the model for its prediction?
    ...
    \item
    Demonstrate the extrapolation problem on a dataset of your choice. You can, but do not have to, use the \texttt{extrapolation.csv} dataset from this exercise. \\
