...
female to male, always leads to the maximum feature-wise distance of 1.
Outliers in age, could further aggrevate this issue.
...
\begin{itemize}
  ...
  \item Weight categorical features with the average standard deviation of numerical features. If numerical features have a high standard deviation, categorical features
  receive higher weights, and therefore dominate the distance calculation. 
  For low standard deviations, numeric features dominate the distance calculation.\\
  Source: Huang, Zhexue. 1998. “Extensions to the K-Means Algorithm for Clustering Large Data Sets with Categorical Values.” Data Mining and Knowledge Discovery 2 (3). Springer: 283–304.
  \item Use exercise 3 of exercise sheet 1 to find a ranking of the nominal scaled features. 
