...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \end{equation}
        the distribution of $X_1$ conditional on $X_2=a$ is the multivariate normal $\mathcal{N}(\bar{\boldsymbol{\mu}}, \overline{\boldsymbol{\Sigma}})$
        \begin{equation}
            \bar{\boldsymbol\mu}
            =
