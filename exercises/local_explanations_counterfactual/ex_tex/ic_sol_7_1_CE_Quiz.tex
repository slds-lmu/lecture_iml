...
Which of the following statement(s) about counterfactual explanations is/are correct? 
        ...
        \textcolor{blue}{Not correct, it is the opposite. The Rashomon effect got its name from the 1950 Japanese film Rashomon and states that there can be multiple equally plausible explanation for the same thing. For counterfactual explanations, this means that there can exist multiple, equally good explanations for the same prediction.}
        \item In the MOC approach human preferences influence how counterfactual explanations are generated.
        \textcolor{blue}{Not correct, a whole set of counterfactuals is generated that reflect trade-offs of different objectives (validity, proximity, sparsity, plausibility). Only afterwards, the user can select from that set the prefered counterfactual.}
    \end{enumerate}
}
