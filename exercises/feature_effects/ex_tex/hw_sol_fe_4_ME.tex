...
\begin{align*}
  \hat f(x_1\!+\!h_1,x_2)
  &=\theta_0+\theta_1(x_1+h_1)^2+\theta_2x_2^2+\theta_{1,2}(x_1+h_1)x_2 \\
  &=\theta_0+\theta_1\bigl[x_1^2+2x_1h_1+h_1^2\bigr]
    \;+\;\theta_2x_2^2
    \;+\;\theta_{1,2}x_1x_2+\theta_{1,2}h_1x_2.
\end{align*}

Note that $\theta_0$ cancels in the subtraction $\hat f(x_1+h_1,x_2)-\hat f(x_1,x_2)$:
...
For \(T=9\) equidistant \(t_i\in(0,1)\):
\[
  t_i=\frac{i}{9+1}, \quad
