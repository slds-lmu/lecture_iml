...
\begin{enumerate} [a)]
  ...
  \begin{equation*}
   \fh(\xv) = \fh(x_1, x_2) = \hat\theta_1 x_1 + \hat\theta_2 x_2 + \hat\theta_3 x_1 x_2 + \hat\theta_0
  \label{eq:linmod}
  \end{equation*}
  
  $$
  \begin{aligned}
  f_{1, PD}(x_1) = \E_{x_2} \left( \fh(x_1, x_2) \right) &= \int_{-\infty}^{\infty} \left( \hat\theta_1 x_1 + \hat\theta_2 x_2 + \hat\theta_3 x_1 x_2 + \hat\theta_0 \right) \, d\P(x_2) \\
  &= \hat\theta_1 x_1 + \int_{-\infty}^{\infty} \hat\theta_2 x_2 + \hat\theta_3 x_1 x_2 \, d\P(x_2) + \hat\theta_0 \\
    &= \hat\theta_1 x_1 + \int_{-\infty}^{\infty} (\hat\theta_2 + \hat\theta_3 x_1) x_2 \, d\P(x_2) + \hat\theta_0 \\
    &= \hat\theta_1 x_1 + (\hat\theta_2 + \hat\theta_3 x_1) \cdot \int_{-\infty}^{\infty} x_2 \, d\P(x_2) + \hat\theta_0 \\
        &= \hat\theta_1 x_1 + (\hat\theta_2 + \hat\theta_3 x_1) \cdot \E_{x_2} (x_2) + \hat\theta_0 
  \end{aligned}
  $$

  \item PD function for $\hat\theta_0 = 0$, $\hat\theta_1 = -8$, $\hat\theta_2 = 0.2$, $\hat\theta_3 = 16$, $X_1 \sim Unif(-1, 1)$ and  $X_2 \sim B(1, 0.5)$. 
  $$
  \begin{aligned}
  f_{1, PD}(x_1) = \hat\theta_1 x_1 + (\hat\theta_2 + \hat\theta_3 x_1) \cdot \E_{x_2} (x_2) + \hat\theta_0 
