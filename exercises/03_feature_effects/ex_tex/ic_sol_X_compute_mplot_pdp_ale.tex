\loesung{
We solve the exercise step-by-step:
...
\textbf{Derivation:}
    ...
    \[
    \hat{f}_{1, M}(x_1) = \mathbb{E}_{x_2 \mid x_1} \left[ -x_1 + 2x_2 \mid x_1 \right].
    \]
...
\[
\mathbb{E}[x_2 \mid x_1] = \rho \frac{\sigma_2}{\sigma_1} x_1.
\]

If in addition \(\sigma_1 = \sigma_2 = \sigma\), we have:
\[
...
\begin{enumerate}
    ...
    Substituting \(\hat{f}(x_1, x_2) = -x_1 + 2x_2\):
    \[
    \hat{f}_{1, \text{pdp}}(x_1) = \mathbb{E}_{x_2} \left[ -x_1 + 2x_2 \right].
    \]
    Since \(-x_1\) is constant:
    \[
    \hat{f}_{1, \text{pdp}}(x_1) = -x_1 + 2 \cdot \mathbb{E}[x_2].
    \]
