...
We know that all PD-functions have the same expectation $\mu$ (and by subtraction of $\mu$ one obtains the centered versions), which implies
...
$$
hence $\tilde{g}^c_{1,2}(x_1, x_2)$ is indeed the centered version of $\tilde{g}_{1,2}(x_1, x_2)$.
