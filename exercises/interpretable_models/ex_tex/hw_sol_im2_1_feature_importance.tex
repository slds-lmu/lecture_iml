...
\begin{table}[H]
	...
	\textbf{Why does this make sense?} In componentwise boosting, each iteration selects the base learner (feature) that reduces the risk the most. The cumulative risk reduction per feature therefore measures how much each feature contributes to the model's predictive performance over the course of training.
