...
\begin{enumerate}[a)]
    ...
    \textit{Hint:} In R with \texttt{mgcv}, you can add a tensor product interaction via \texttt{gam(y \textasciitilde{} s(x1) + s(x2) + ti(x1, x2))}. In Python with \texttt{pyGAM}, you can use tensor product terms via the \texttt{te()} function.
