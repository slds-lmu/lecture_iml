...
Note that each loss evaluation requires a pass over all $n$ data points to compute the child node variances, leading to a time complexity of $O(n^2)$ for one feature and $O(dn^2)$ for all features.
