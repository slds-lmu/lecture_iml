...
Note that in this exercise, we focus on the relationship between $x_1$ and $x_2$; the variable $y$ is not used here.
...
\begin{enumerate}[a)]
    ...
    Unlike the ordinary $R^2$, the adjusted $R^2$ can become negative, indicating a model that is worse than simply predicting the mean.
    Interpret the $R^2$ and adjusted $R^2$ values for the two models.
