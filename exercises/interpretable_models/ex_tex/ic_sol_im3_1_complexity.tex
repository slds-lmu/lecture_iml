...
\begin{figure}[H]
	\centering
	\includegraphics[width=.3\textwidth]{figure/complexity_example_plot.png}
\end{figure}
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\hspace{3cm}\includegraphics[width = .3\textwidth, ]{figure/complexity_example_plot2.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = .8\textwidth]{figure/complexity_example.png}
	\end{figure}
	...
	Ideas:
	\begin{itemize}
		\item Number of parameters or df (split points, averages vs. coefficients)
		\item Area below or above curve compared to linear model
		\item Average does not work, rather measures difference to $H_0: \theta = 0$ 
		\item Influence of outliers or noise (how much do predictions change)
		\item Degree of polynomial with a good approximation, taylor series, degrees of freedom for splines, etc.
	\end{itemize}
