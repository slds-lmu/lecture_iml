...
\begin{enumerate}[a)]
    ...
    See calculation results in the implementations, as they again depend on the specific implementation, the seed and other parameters. 
	...
	\begin{algorithm}[H]
		...
		\begin{algorithmic}[1]
			...
			\State \texttt{remainder} $\gets$ all features in \texttt{X} but \texttt{S}
