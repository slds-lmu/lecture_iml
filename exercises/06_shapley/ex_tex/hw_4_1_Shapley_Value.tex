...
\begin{enumerate}
    ...
    \begin{itemize}
    	...
    	\item Start by implementing the function \texttt{payoff(set)}, which should return the payoff of a subset \texttt{set} as given in the task. You can do this, for example, by first assigning a Boolean value for each player.
