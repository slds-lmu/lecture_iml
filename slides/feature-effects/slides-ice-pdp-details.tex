...
Aim: When ICE curves start at different intercept and are stacked, it is difficult to identify heterogenous predictions.
...
\begin{center}\includegraphics[width=0.65\textwidth]{figure_man/xor.pdf} \end{center}
%
% \framebreak
%
% \begin{itemize}
