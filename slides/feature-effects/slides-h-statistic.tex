...
\textbf{Advantages:}
\begin{itemize}
	\item The H-statistic is dimensionless such that its values can be compared across features and even across models. 
	\item It detects all kinds of interactions, regardless of their particular form. 
	\item The H-statistic could also be extended to analyze the interaction strength of 3 or more features. 
\end{itemize}

\textbf{Disadvantages:}
\begin{itemize}
	\item The H-statistic is expensive to evaluate, because it iterates over all data points and at each point the PD has to be evaluated using all $n$ data points. 
	\item Using only a sample of the $n$ data points could result in unstable H-statistics.
\end{itemize}
\end{frame}
