...
\newcommand{\titlefigure}{figure_man/feature-effects}
...
% However, if the model contains interactions, there is a modifying effect for certain observations that changes the slope of the regression line (in case of LMs) or the shape of the partial effect curve (in case of GAMs).
...
\end{column}
\begin{column}{0.55\textwidth}
\includegraphics[page=2, width=0.95\textwidth]{figure_man/ICE}
\end{column}
\end{columns}
\vspace*{\topsep}
...
\end{column}
\begin{column}{0.55\textwidth}
\includegraphics[page=3, width=0.95\textwidth]{figure_man/ICE}
\end{column}
\end{columns}
\vspace*{\topsep}
