...
Partition each observation $\xv$ into $\xv_S$ (features of interest) and $\xv_C$, containing only feature values indexed by $S \subseteq \{1, \dots, p\}$ and its complement $C = S^\complement$.
