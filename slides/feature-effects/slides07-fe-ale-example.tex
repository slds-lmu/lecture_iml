...
\item<2-> \textbf{Key intuition:} “Partitioning turns the feature range into small neighborhoods where effects can be estimated locally.”
\end{itemizeM}
\end{framev}
...
\begin{itemizeM}
\item<4-> \textbf{Key intuition:} “What happens if we move temperature across this small interval?”
\end{itemizeM}
\end{framev}
...
\item<2-> \textbf{Key intuition:} “Average only over observations that actually live in this temperature region.”
\end{itemizeM}
\end{framev}
...
\end{center}
\begin{itemizeM}
\item<2-> \textbf{Key intuition:} “Add up these small local effects to recover the global temperature effect.”
\end{itemizeM}
\end{framev}
...
\end{center}
\begin{itemizeM}
\item<2-> \textbf{Key intuition:} “Shift the curve so that it has mean zero.”
\end{itemizeM}
\end{framev}
