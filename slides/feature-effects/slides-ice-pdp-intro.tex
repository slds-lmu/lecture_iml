...
\item Learn about visualizations of global feature effects
\item Understand the steps involved in constructing ICE and PD plots
...
\lecturechapter{Individual Conditional Expectation (ICE) \& Partial Dependence (PD) plots}
\lecture{Interpretable Machine Learning}


\begin{vbframe}{Visualizing Feature Effects}
\begin{center}
\includegraphics[width=\textwidth]{figure_man/feature-effects.pdf}
\end{center}
...
\textbf{Aggregation:} Estimate partial dependence by the point-wise average of the ICE curves:
