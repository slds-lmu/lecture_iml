...
\lecturechapter{13}{Accumulated Local Effects}
...
\frame{
  \frametitle{PD vs. ALE}
    ...
    $
    \begin{aligned}
      \hspace{2cm} \E_{\xv_C} \left( \fh(x_S, \xv_C) \right) = \int_{-\infty}^{\infty} \fh(x_S, \xv_C) \, d\mathcal{P}(\xv_C)
    \end{aligned}
    $ \\
    \textbf{ALE:}
    $
    \begin{aligned}
      \only<1>{\hspace{1cm}
      \int_{z_{0}}^{x} \mathbb{E}_{\xv_C \vert x_S} \left[\textcolor{purple}{\frac{\partial \fh(x_S, \xv_C)}{\partial x_S}} \textcolor{blue}{\bigg \vert x_S = z_S} \right] dz_S\\
        = \int_{z_{0}}^{x} \left[ \int_{-\infty}^{\infty}  \textcolor{purple}{\frac{\partial \fh(x_S, \xv_C)}{\partial x_S}} d \textcolor{blue}{\mathcal{P}(\xv_C | z_S) } \,   \right] dz_S}
    \only<2>{\hspace{1cm}
    \textcolor{blue}{\int_{z_{0}}^{x}} \mathbb{E}_{\xv_C \vert x_S} \left[\frac{\partial \fh(x_S, \xv_C)}{\partial x_S} \bigg \vert x_S = z_S \right] \textcolor{blue}{dz_S}\\
  = \textcolor{blue}{\int_{z_{0}}^{x}} \left[ \int_{-\infty}^{\infty}\frac{\partial \fh(x_S, \xv_C)}{\partial x_S} d \mathcal{P}(\xv_C | z_S)  \,   \right]}
  \end{aligned}
    $
    \lz
    \begin{itemize}
