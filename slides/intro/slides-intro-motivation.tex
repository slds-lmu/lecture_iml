...
\begin{frame}{Need for Interpretability in High-stakes Decisions}
    ...
    \citebutton{EU's 'Right to Explanation'}{https://doi.org/10.1609/aimag.v38i3.2741}
    
    $\leadsto$ Ethics guidelines for trustworthy AI \citebutton{European Commission}{https://doi.org/10.2759/346720}
