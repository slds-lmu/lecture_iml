   ...
   \end{tikzpicture}}
	...
	\only<3>{\begin{itemize}
		...
		%\itemsep1em
			...
			%\item Feature effect methods \& feature importance methods
			...
			%, \\e.g., feature importance for linear model %decision trees
			%\item Different types of explanations:
...
%     \end{center}
	...
	\medskip
		\begin{itemize}
		%\itemsep1em
			\item Identify training instances that are most responsible for a decision
		    \item Influence Functions
		\end{itemize}
	\end{itemize}}
	
	\only<5>{
	\textbf{Example:} Consider the following prediction:
	\begin{center}
	...
	\begin{center}
		\includegraphics[page=1, width=0.5\textwidth]{figure/Chihuahua_or_muffin.png} 
	\end{center}
	\end{column}
	\begin{column}{0.5\linewidth}
	Left: Part of training data set
	\begin{itemize}
	    \item[$\leadsto$] Model chose the wrong output (muffin instead of chihuahua)
	\end{itemize}
	\end{column}
	\end{columns}}
