...
\begin{frame}{High-Dimensional Model Representation \citebutton{Sobol (2003)}{https://doi.org/10.1016/S0951-8320(02)00229-6}}
...
%\vspace{5pt}
% \centerline{$\fh(\xv) = g_{\{0\}} + g_{\{1\}}(x_1) + g_{\{2\}}(x_2) + \dots + g_{\{1, 2\}}(x_1, x_2) + \dots + g_{\{1,\ldots,p\}}(x_1, \ldots, x_p)$}
%\vspace{5pt}
\begin{equation*}
\begin{split}
\fh(\xv) =  %g_{\{0\}} +
...
% \begin{align*}
% \fh(\xv) &= g_{\{0\}} + g_{\{1\}}(x_1) + g_{\{2\}}(x_2) + \;\dots\; + g_{\{1, 2\}}(x_1, x_2) \\
