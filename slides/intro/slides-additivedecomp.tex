...
\item The PD on a subset of features $X_S$ is the minimum L2 loss approximation of the prediction function given $X_S$, denoted by $\mathbb{E}_{X_{-S}}\left[\widehat{f}(x) \; \vert \; X_S \right]$, where $X_{-S}$ is the subset of complementary features.
...
Consider a recursive estimation of the decomposition via the PD:
\begin{align*}
