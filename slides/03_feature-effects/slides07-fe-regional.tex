...
\begin{itemize}
    \item introduce bike sharing dataset
    \item fit a neural network
\end{itemize}    
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.3\linewidth]{slides/03_feature-effects/figure/01_bike_sharing_dataset_18_0.png}
    \includegraphics[width=0.3\linewidth]{slides/03_feature-effects/figure/01_bike_sharing_dataset_18_1.png}
    \includegraphics[width=0.3\linewidth]{slides/03_feature-effects/figure/01_bike_sharing_dataset_18_2.png}\\
    \includegraphics[width=0.3\linewidth]{slides/03_feature-effects/figure/01_bike_sharing_dataset_18_4.png}
    \includegraphics[width=0.3\linewidth]{slides/03_feature-effects/figure/01_bike_sharing_dataset_18_5.png}    
...
\begin{frame}{Regional Effect Plots - Real Example}
    ...
    \begin{tikzpicture}[every node/.style={anchor=south, align=center}]
        % Root image
        \node (root) {\includegraphics[width=0.25\textwidth]{slides/03_feature-effects/figure/01_bike_sharing_dataset_18_1.png}};

        % Depth 1 (Appears on Slide 2)
        \node[below left=-.2cm and .8cm of root] (child1) {\includegraphics[width=0.25\textwidth]{slides/03_feature-effects/figure/01_bike_sharing_dataset_28_0.png}};
        \node[below right=-.2cm and .8cm of root] (child2) {\includegraphics[width=0.25\textwidth]{slides/03_feature-effects/figure/01_bike_sharing_dataset_28_1.png}};
        ...
        \node[below left=0.3cm and -1cm of child1] (child11) {\includegraphics[width=0.25\textwidth]{slides/03_feature-effects/figure/01_bike_sharing_dataset_29_0.png}};
        \node[below right=0.3cm and -1cm of child1] (child21) {\includegraphics[width=0.25\textwidth]{slides/03_feature-effects/figure/01_bike_sharing_dataset_29_1.png}};
        \node[below left=0.3cm and -1cm of child2] (child12) {\includegraphics[width=0.25\textwidth]{slides/03_feature-effects/figure/01_bike_sharing_dataset_29_2.png}};
        \node[below right=.3cm and -1cm of child2] (child22) {\includegraphics[width=0.25\textwidth]{slides/03_feature-effects/figure/01_bike_sharing_dataset_29_3.png}};
    ...
    \begin{tikzpicture}
        % Draw a generic textbox anywhere
        \node[draw, fill=yellow!20, text width=3cm] at (3,-15) {This is a generic textbox!};
    \end{tikzpicture}
\end{frame}
