...
\item[] Role of interpretation for... 
\item ... gaining insides about data
\item ... improving model (debug and audit)
\item ... understanding and controlling individual predictions
...
\textbf{Example:} Neural Net Tank \citebutton{gwern.net}{https://www.gwern.net/Tanks} \\
    ...
    \only<3>{\vspace{0.7cm}
            \includegraphics[width=0.45\textwidth]{figure/tank.jpg}
            \includegraphics[width=0.45\textwidth]{figure/tank_green.jpg}
	        \includegraphics[width=0.45\textwidth]{figure/landscape.jpg}
	        \includegraphics[width=0.45\textwidth]{figure/landscape_green.jpg}}
	\end{column}
