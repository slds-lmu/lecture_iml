...
\begin{frame}{Joint, Marginal and Conditional Distribution}
    Let $X_1, X_2$ be two descrete random variables of two outcome spaces $\mathcal{X}_1, \mathcal{X}_2$, respectively. %with joint probability mass function $p(x_1,x_2)$. 
    ...
    \begin{itemize}
        ...
        \begin{align*}
            \mathbb{P}(X_1, X_2) = p(x_1,x_2) %\sum_{(x_1,x_2)\in (X_1,X_2)} p(x_1,x_2)
        \end{align*}
        \item Marginal distribution
        \begin{align*}
            \mathbb{P}(X_1) = \sum_{x_2\in \mathcal{X}_2} p(x_1,x_2)
        \end{align*}
...
\begin{frame}{Mutual Information}
    \begin{itemize}
        \item MI describes the amount of information about one random variable obtained through the other one or how different the joint distribution is from pure independence
        \item The MI $I(X_1 ; X_2 )$ is the Kullback-Leibler distance between the joint distribution and the product distribution $\mathbb{P}(X_1) \mathbb{P}(X_2)$:
        \begin{align*}
            I(X_1 ; X_2 ) &= \sum_{x_1 \in \mathcal{X}_1} \sum_{x_2 \in \mathcal{X}_2} \mathbb{P}(x_1, x_2) log\left(\frac{\mathbb{P}(x_1, x_2)}{\mathbb{P}(X_1) \mathbb{P}(X_2)} \right) \\
            &= D_{KL} \left( \mathbb{P}(x_1, x_2) \, || \, \mathbb{P}(X_1) \mathbb{P}(X_2) \right) \\
            &= \mathbb{E}_{\mathbb{P}(x_1, x_2)} \left[ log\left(\frac{\mathbb{P}(x_1, x_2)}{\mathbb{P}(X_1) \mathbb{P}(X_2)} \right) \right]
        \end{align*}
