...
\item Credit scoring and insurance applications
    ...
    \furtherreading{Society_of_Actuaries_2021}
    \begin{itemize}
...
\begin{frame}{Need for interpretability}
    ...
    % new
    \furtherreading{Goodman_Flaxman_2017}
    \\
    ...
    % new
    \furtherreading{European_Commission_2019}
...
}
{
    ...
    % new
    \centering \furtherreading{Gauss_1828}
    \centering \furtherreading{Wikipedia_Gauss}
    \bigskip\\
