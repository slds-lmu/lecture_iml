...
\item Difference of dependence vs. correlation
\item Role of feature dependence in IML
}
...
\begin{itemize}
    ...
    \only<2>{\item[$\leadsto$] °F $\rightarrow$ °C $\Rightarrow$ ${\color{blue}\theta_1=78.5}\rightarrow{\color{ggblue}\theta_1^*=141.3}$}
    \pause
...
\begin{columns}[c, totalwidth=\textwidth]
    ...
    \vspace{-0.75cm}
    \begin{align*}
    MI(X_1 ; Y) = & \,0.5\, log\left(\frac{0.5}{0.833 \cdot 0.5} \right) 
    + 0.333\, log\left(\frac{0.333}{0.833 \cdot 0.5} \right) \\
    &+ 0\, log\left(\frac{0}{0.167 \cdot 0.5} \right) 
    + 0.167\, log\left(\frac{0.167}{0.167 \cdot 0.5} \right) \\
    = & \,0.133
    \end{align*}}
