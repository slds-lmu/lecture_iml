...
\begin{frame}{Joint, Marginal and Conditional Distribution}
    ...
    \textit{Conditional distribution}
        ...
        \end{align*}
    $\leadsto$ Analogue in continuous case with integrals. 
    \end{column}
...
\medskip
\centering
\includegraphics[width = \textwidth]{figure/dependence_3}}
\end{frame}
...
\colorbox{blue!20}{
\includegraphics[trim=0px 110px 30px 0px, clip, width=.65\linewidth]{figure/ridge_lasso} }
...
$\leadsto$ Explanations maybe biased if they rely on pred. where model extrapolated\\
\pause
%\item 
