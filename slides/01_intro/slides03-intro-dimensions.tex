   ...
   \end{tikzpicture}}
	...
	\begin{column}{0.77\linewidth}
	    Model-specific methods:
			...
			\begin{itemize}
		    %\itemsep1em
		        \item Interpretation method applicable to a specific ML model
...
\end{itemize}
	...
	\only<5-6>{Data Attribution: Identify training instances most responsible for a decision 
    \medskip
	...
	\only<5>{
    	Question: How does this incorrect prediction come about? 
	\begin{center}
		\includegraphics[page=1, width=0.65\textwidth]{figure/Chihuahua_or_muffin_model.png}
	\end{center}
}
	
	\only<6>{
	Answer: Look at training data and find data points caused the model prediction.
    ...
    \begin{itemize}
        \item[$\leadsto$] Training images looking most like new input show a muffin 
...
\begin{columns}[c, totalwidth=\textwidth]
    ...
    \end{itemize}
    \textbf{Regional explanations} -- for \textbf{subspaces}:
    \begin{itemize}
    ...
    % \includegraphics<1>[width=\textwidth]{slides/01_intro/figure/01_bike_sharing_dataset_18_1.png}    
...
% \includegraphics[width=0.35\textwidth]{slides/01_intro/figure/01_bike_sharing_dataset_18_1.png}       
% \end{center}
...
% \includegraphics[width=\textwidth]{slides/01_intro/figure/01_bike_sharing_dataset_28_0.png}
%     \end{column}
%     \begin{column}{0.05\textwidth}
%     \end{column}
%     \begin{column}{0.325\textwidth}
% \includegraphics[width=\textwidth]{slides/01_intro/figure/01_bike_sharing_dataset_28_1.png}
%     \end{column}
%     \begin{column}{0.15\textwidth}
%     \centering
