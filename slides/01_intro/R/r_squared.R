...
ggsave("../figure_man/r_squared_Fahrenheit.pdf", width=7, height=5.5)
...
ggsave("../figure_man/r_squared.pdf", width=7, height=5.5)
...
ggsave("../figure_man/r_squared_compare.pdf", width=7, height=5.5)
