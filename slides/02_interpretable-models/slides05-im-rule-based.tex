...
\begin{frame}{Bike-Example: ctree}
\centering
\includegraphics[width = .9\textwidth]{figure/bike_ctree.pdf}
\end{frame}
...
\begin{itemize}
    ...
    \item Instead of a constant model (CART), a parametric model is fitted in each node % OLS regression, GLMs, and survival regression
\end{itemize}

\includegraphics[width = \textwidth]{figure/bike_mob.pdf}

\raggedright
Comparison RMSE \texttt{ctree}: 696,180.7 \, ; \texttt{mob}: 11,994,124.1
