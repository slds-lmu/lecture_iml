...
\begin{itemize}
    ...
    \item Parametric model is fitted in leave nodes % OLS regression, GLMs, and survival regression
\end{itemize}
...
\textbf{Example:} Bike data (here: linear model in final nodes)

\vspace{-0.2cm}
\includegraphics[width = 1.05\textwidth]{figure/bike_mob.pdf}

\vspace{-0.1cm}
\centering
Comparison RMSE: \quad \texttt{ctree}: 696,180.7 \, ; \, \texttt{mob}: 11,994,124.1
