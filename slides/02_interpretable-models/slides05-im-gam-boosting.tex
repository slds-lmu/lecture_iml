...
\begin{itemize}
    ...
    \item Interpretation needs to be done visually and relative to average prediction, also see PDPs
...
%\pause
\item
Possible to combine BL of same type (with distinct parameters $\thetab$ and $\ts$):
