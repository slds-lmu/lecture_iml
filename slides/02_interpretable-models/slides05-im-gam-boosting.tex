...
\begin{itemize}
    \item E.g. iteration 1: \code{days\_since\_2011} causes a risk reduction (MSE) of 140,782.94
...
\smallskip
\scriptsize
\only<2->{\qquad $\Rightarrow$ In-bag-Risk: 250,202.0 \, ; \, OOB risk (10-fold CV): 267,497.0 (Difference: 178,953.0)}
\begin{itemize}
    \normalsize
