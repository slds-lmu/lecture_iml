...
\begin{frame}{Decision Trees \furtherreading{Breiman_et_al_1984}}
...
\vspace{-0.2cm}
\furtherreading{Hothorn_et_al_2006}
\furtherreading{Zeileis_et_al_2008}
\furtherreading{Strobl_et_al_2007}
...
\begin{columns}[c, totalwidth=\textwidth]
    \begin{column}{0.6\textwidth}
        \textbf{Decision Rules} \furtherreading{Holte_1993}
        \begin{itemize}
...
\begin{columns}[c, totalwidth=\textwidth]
    \begin{column}{0.65\textwidth}
        ...
        % \end{itemize}
        \textbf{RuleFit} \furtherreading{Friedman_Popescu_2008}
\begin{itemize}
