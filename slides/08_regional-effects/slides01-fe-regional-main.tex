...
\begin{frame}{Recap: Global vs.\ Local Explanations}
      ...
      \textbf{Global} (e.g.\ Partial Dependence, global feature importance)
      \begin{itemize}
        \item[\textbf{+}] Summarises average model behaviour across the whole feature space
...
\begin{frame}{VINE: Visual INteraction Effects \citebutton{Britton (2019)}{https://arxiv.org/abs/1904.00561}}
...
\begin{itemize}
    ...
    \item[$\Rightarrow$] Recursive partitioning(CART): Find best feature-split combination that minimizes
...
\begin{frame}{Regional Effect Plots - Real Example}
    ...
    \begin{tikzpicture}[every node/.style={anchor=south, align=center}]
        ...
        \node[below left=-.2cm and .8cm of root] (child1) {\includegraphics[width=0.25\textwidth]{figure/01_bike_sharing_dataset_28_0.png}};
        \node[below right=-.2cm and .8cm of root] (child2) {\includegraphics[width=0.25\textwidth]{figure/01_bike_sharing_dataset_28_1.png}};
        ...
        \node[below left=0.3cm and -1cm of child1] (child11) {\includegraphics[width=0.25\textwidth]{figure/01_bike_sharing_dataset_29_0.png}};
        \node[below right=0.3cm and -1cm of child1] (child21) {\includegraphics[width=0.25\textwidth]{figure/01_bike_sharing_dataset_29_1.png}};
        \node[below left=0.3cm and -1cm of child2] (child12) {\includegraphics[width=0.25\textwidth]{figure/01_bike_sharing_dataset_29_2.png}};
        \node[below right=.3cm and -1cm of child2] (child22) {\includegraphics[width=0.25\textwidth]{figure/01_bike_sharing_dataset_29_3.png}};
