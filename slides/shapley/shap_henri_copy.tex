...
\begin{itemize}
    ...
    $$\mathbf{z}_{k}^{\prime} \in\{0,1\}^{p}, \quad k \in\{1, \ldots, K\}$$
...
\begin{table}[]
  ...
  Coalition (S) & $\mathbf{z}_{k}^{\prime}$ &  hum & temp & ws \\
  \hline 
  $\varnothing$ & $z^{\prime}_{1}$ & 0 & 0 & 0  \\
  hum & $\mathbf{z}^{\prime}_{2}$ & 1 & 0 & 0  \\
  temp &  $\mathbf{z}^{\prime}_{3}$ & 0 & 1 & 0  \\
  ws &   $\mathbf{z}^{\prime}_{4}$ & 0 & 0 & 1  \\
  hum, temp & $\mathbf{z}^{\prime}_{5}$ & 1 & 1 & 0  \\
  temp, ws & $\mathbf{z}^{\prime}_{6}$ & 0 & 1 & 1  \\
  hum, ws &   $\mathbf{z}^{\prime}_{7}$ & 1 & 0 & 1  \\
  hum, temp, ws & $\mathbf{z}^{\prime}_{8}$ & 1 & 1 & 1  \\
...
\phi_{0}+\sum_{j=1}^{p}
 \phi_{j} z_{j}^{\prime} \only<2>{\leadsto g\left(z^{\prime}\right)=
4515 +
 34 \cdot z_{hum}^{\prime} - 1654 \cdot z_{temp}^{\prime} - 323 \cdot z_{ws}^{\prime} }
$$
