...
\begin{itemize}
  \item Players $\hat{=}$ feature values of $i$-th observation $\xij, j \in \pset$.
...
\begin{center}
\vspace{-0.3cm}
\includegraphics[width=0.7\textwidth]{figure_man/shapley_valuefct}
\end{center}
...
\begin{itemize}
  ...
  The feature value $\xij$ contributed $\phiij$ towards the prediction $\fh(\xi)$ compared to the average prediction for the dataset.
