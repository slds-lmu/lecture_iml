...
\begin{itemize}[<+->]
    ...
    \\ 
    $\leadsto$ Partial dependence: $\fh_{S}(\xv_S) := \int_{X_{-S}} \fh(\xv_S, X_{-S})d \P_{X_{-S}}$
...
\begin{itemize}
    ...
    \item Difference between model prediction of this observation and the average prediction of the data is fairly distributed among the features (i.e., 4434.86 - 4507.67 = )
