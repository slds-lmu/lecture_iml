...
\begin{definition}
    ...
    % = \mathbb{E}_{\Xv_{-S}} \left[\fh(\xv_S, \Xv_{-S}) \; \middle\vert \; \xv_S \right] - \sum_{V \subset S} g_V(\xv_V)
...
\begin{example}
    ...
    \begin{itemize}
        ...
        \item[$\Rightarrow$] Parts of interaction term attributed to main effects (correctly!)
        }
