...
Need for interpretability becomes increasingly important from a legal perspective
\begin{itemizeM}
...
\item \textit{The EU Artificial Intelligence Act} \furtherreading{EUROPEANCOMMISSION2024}
\end{itemizeM}
\imageC[0.6]{figure/rightstoexplain.jpg}
