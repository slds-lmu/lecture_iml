...
% Provenance kept from removed redundant legacy "Why Interpretability?" side image:
...
\spacer[0.25]
A related presentation can be found in \furtherreading{ADADIBERRADA2018}.
% Provenance kept from removed redundant legacy "When do we need interpretability?" frame:
...
\begin{framev}[align=top]{Discover and gain global insights}
...
\textit{Exemplary question:}\\
Which feature influences model performance and how much?
\imageC[0.8]{figure/bike-sharing02.png}
\begin{itemizeM}
...
\begin{framev}[align=top]{Improve, debug and audit models}
...
\spacer[0.25]
\centering
\only<1>{\image{figure/tank.jpg}}
\only<2>{
\splitVTT[1]{
\centering \image[0.75]{figure/tank.jpg} \spacer[0.25] \image[0.75]{figure/landscape.jpg}}{}
}
\only<3>{
\twobytwo
{\image[0.99]{figure/tank.jpg}}
{\image[0.99]{figure/tank_green.jpg}}
{\image[0.99]{figure/landscape.jpg}}
{\image[0.99]{figure/landscape_green.jpg}}
}
}{
...
\begin{framei}[align=top]{Debug and Audit}
...
\begin{framev}[align=top]{Understand \& control individual preds}
...
\only<1>{
\begin{center}
\includegraphics[page=1,width=0.6\linewidth]{figure/counterfactuals_credit.pdf}
\end{center}
Questions:
}
\begin{itemizeM}
...
\only<2>{
\begin{center}
\includegraphics[page=2,width=0.6\linewidth]{figure/counterfactuals_credit.pdf}
\end{center}
...
\begin{framev}[align=top]{Justification and fairness}
$\leadsto$ Investigate if and why predictions are biased, unexpected, or discriminatory\\
\spacer[0.25]
...
\begin{framev}[align=top]{Justification and fairness: COMPAS~\furtherreading{LARSON2016}}
$\leadsto$ Investigate if and why predictions are biased, unexpected, or discriminatory\\
\spacer[0.25]
...
\begin{framev}[align=top]{Justification and fairness: COMPAS \furtherreading{ALVAREZMELISJAAKKOLA2018}}
$\leadsto$ Investigate if and why predictions are biased, unexpected, or discriminatory\\
\spacer[0.25]
...
\spacer[0.25]
\centering
\includegraphics[trim=695 50 5 0,width=0.99\textwidth,clip]{figure/COMPAS_shap_lime_example.png}
}{
\spacer[0.25]
\begin{itemizeM}
