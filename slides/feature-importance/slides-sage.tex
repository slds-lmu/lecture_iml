...
\begin{itemize}
	\item definition of importance
	\item marginalization of prediction function
	\item quantification defined in terms of sets
	\item improvement over set
	\item link to mutual information etc
\end{itemize}

\end{vbframe}


\begin{vbframe}{SAGE values}

reference to Shapley chapter
