...
%	\end{tikzpicture} 
%\hfill
\includegraphics[width=0.5\linewidth]{figure_man/simulation_loco_corr.pdf} 
\hfill
\includegraphics[width=0.4\linewidth]{figure_man/simulation_loco}
%\hfill
%\end{figure}

Left: Correlation matrix

Right: LOCO importance for fitted LM on 70\% of the data computed on 30\% remaining observations
