...
%	\end{tikzpicture} 
%\hfill
	\includegraphics[width=0.35\linewidth]{figure_man/simulation_loco_corr.pdf} 
\hfill
...
\textbf{Example:} Sample $1000$ observations with $x_1, x_3 \sim N(0, 5), x_2 = x_1 + \epsilon_2$ with $\epsilon_2 \sim N(0, 0.1)$ and $y = x_2 + x_3 + \epsilon$ with $\epsilon \sim N(0, 2)$. Left: Correlation matrix, Right: LOCO importance for fitted LM on 70\% of the data computed on 30\% remaining observations.
