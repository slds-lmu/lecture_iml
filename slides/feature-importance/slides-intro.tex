...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textbf{Does feature $\xj$ contribute information that isn't already contained in features $\xv_S$?}
  \end{itemize}
  \item Inference
  \begin{itemize}
    \item Does $\xj$ share information with $\ydat$
    \item \textbf{Does $\xj$ share information with $\ydat$ given $\xv_S$}
