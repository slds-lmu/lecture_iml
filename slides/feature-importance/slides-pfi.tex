...
\bibliography{feature-importance.bib}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{figure_man/bike-sharing02.png}
\end{center}
...
A \texttt{lm} is fit, yielding $\fh(x) \approx 0.3 x_1 - 0.3 x_2 + x_3$.\\
 %
\begin{figure}
  \includegraphics[width=0.55\linewidth]{figure_man/pimp.pdf}
