...
%\\
%\lz
\textbf{Example:}  \citebutton{Molnar et. al (2020)}{https://arxiv.org/abs/2006.04628}
...
\begin{itemize}
    ...
    \item \textbf{Top left:} For $X_2<0.5$, permuting $X_1$ (crosses) extrapolates
    \item \textbf{Top right:} Permuting $X_1$ within groups $X_2<0.5$, $X_2\geq 0.5$ reduces extrapolation
    \item \textbf{Bottom left:} Marginal density of $X_1$
    \item \textbf{Bottom right:} Densities of $X_1$ conditional on the subgroups
\end{itemize}
\end{column}
\end{columns}
