...
\begin{itemize}
  ...
  $\leadsto$ no prediction-relevant information is destroyed by conditional permutation
\end{itemize}
\lz
\textbf{Entanglement with model:}
\begin{itemize}
  \item If the model does mechanistically use a feature $\Rightarrow$ CFI $= 0$
