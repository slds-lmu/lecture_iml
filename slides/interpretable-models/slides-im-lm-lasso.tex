...
$$y = \beta_0 + \beta_1 x_1 + \beta_2 x_2 + \dots + \beta_p x_p + \epsilon = \xv^\top \beta + \epsilon$$
   ...
   \pause
    ...
    \begin{itemize}[<+->]
    \item Predictions are a \textbf{linear} combination of features $\leadsto$ model equation is additive and linear% and identical across entire input space
    ...
    $\leadsto$ if violated, inference-based metrics (e.g., t-statistics, p-values) are invalid
