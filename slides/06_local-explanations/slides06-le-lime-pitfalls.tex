...
\begin{columns}
    ...
    \begin{column}{0.6\textwidth}
        ...
        \begin{itemize}
        	\item \textbf{Problem}: Instability because of specification of superpixels for image data\documentclass[11pt,compress,t,notes=noshow, aspectratio=169, xcolor=table]{beamer}
