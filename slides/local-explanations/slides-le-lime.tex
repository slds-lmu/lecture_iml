...
\begin{itemize}
		...
		\smallskip\pause
		\item LIME should answer why a machine learning model predicted $\hat y$ for input $\xv$
		\smallskip\pause
...
\begin{frame}[c]{LIME for image data}
	\begin{columns}
		\begin{column}{0.67\textwidth}
			...
			\begin{itemize}
				\item \textbf{Idea}: Each observation is represented by a binary vector indicating the presence or absence of superpixels \citebutton{Achanta et al. 2012}{https://ieeexplore.ieee.org/document/6205760}
