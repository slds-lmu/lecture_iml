...
\begin{vbframe}[containsverbatim,allowframebreaks]{LIME Algorithm}
...
\begin{vbframe}[containsverbatim,allowframebreaks]{Credit Dataset}
	\begin{itemize}
...
%\begin{vbframe}[containsverbatim,allowframebreaks]{Bike Sharing Dataset}
%\vspace{-.3cm}
%
%\begin{center}
...
\begin{vbframe}[containsverbatim,allowframebreaks]{LIME for Text Data}
	...
	\begin{vbframe}[containsverbatim,allowframebreaks]{LIME for image data}
	\begin{columns}
