...
\item See which aspects could undermine users' trust in an explanation
...
\begin{vbframe}{Noisy data}
	\begin{itemize}
		\item What if the ML model was trained on noisy data? Should the explanation model also takes up these noisy patterns? 
