%%% HPO Basics 
\newcommand{\Ilam}{\inducer_{\lamv}} % inducer with HP
...
\newcommand{\tunerfull}{\tuner_{\inducer,\LamS, \rho,\JJ}} % tuner with inducer, search space, perf measure, resampling strategy
