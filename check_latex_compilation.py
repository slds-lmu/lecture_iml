#!/usr/bin/env python3
"""
LaTeX Compilation Checker for Exercise Files

This script recursively scans the exercises directory for .tex files,
...
class LatexChecker:
    ...
    def find_tex_files(self):
        """Find all .tex files in the exercises directory."""
        tex_files = []
