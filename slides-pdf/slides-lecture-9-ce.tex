...
\includepdf[pages={1-last}]{slides06-le-counterfactuals-intro.pdf}

\section{CE - Optimization}
\includepdf[pages={1-last}]{slides07-le-counterfactuals-optim.pdf}

\section{CE - Methods}
\includepdf[pages={1-last}]{slides08-le-counterfactuals-methods.pdf}
