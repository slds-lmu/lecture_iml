...
\includepdf[pages={1-last}]{slides01-fd-intro-motivation_handout.pdf}

\section{Classical Functional ANOVA}
\includepdf[pages={1-last}]{slides02-fd-standard-fANOVA_handout.pdf}

\section{Friedman’s H-Statistic}
\includepdf[pages={1-last}]{slides03-fd-h-statistic_handout.pdf}

\section{Theory of Standard fANOVA}
\includepdf[pages={1-last}]{slides04-fd-constraints-and-theory_handout.pdf}

\section{Further Methods}
\includepdf[pages={1-last}]{slides05-fd-other-methods_handout.pdf}
