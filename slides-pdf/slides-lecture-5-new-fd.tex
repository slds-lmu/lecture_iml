...
\includepdf[pages={1-last}]{slides01-fd-intro-motivation.pdf}

\section{Classical Functional ANOVA}
\includepdf[pages={1-last}]{slides02-fd-standard-fANOVA.pdf}

\section{Friedman’s H-Statistic}
\includepdf[pages={1-last}]{slides03-fd-h-statistic.pdf}

\section{Theory of Standard fANOVA}
\includepdf[pages={1-last}]{slides04-fd-constraints-and-theory.pdf}

\section{Further Methods}
\includepdf[pages={1-last}]{slides05-fd-other-methods.pdf}
