...
\includepdf[pages={1-last}]{slides-fe-ice.pdf}
%\section{Feature Effects - PD plots}
\includepdf[pages={1-last}]{slides-fe-pdp.pdf}
...
\includepdf[pages={1-22}]{slides-fi-pfi.pdf}
...
\includepdf[pages={28-35}]{slides-shap.pdf}
% 
