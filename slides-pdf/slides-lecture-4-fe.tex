...
\includepdf[pages={1-last}]{slides01-fe-intro.pdf}
...
\includepdf[pages={1-last}]{slides04-fe-pdp-comments.pdf}

\section{Feature Effects - Marginal Effects}
\includepdf[pages={1-last}]{slides07-fe-marginal-effects.pdf}

\section{Feature Effects - ALE Plots}
\includepdf[pages={1-last}]{slides05-fe-ale-intro.pdf}
\includepdf[pages={1-last}]{slides06-fe-ale.pdf}
