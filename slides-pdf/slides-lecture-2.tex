...
\includepdf[pages={1-last}]{slides-im-motivation.pdf}

\section{Interpretable Models - Linear Model}
\includepdf[pages={1-last}]{slides-im-lm-lasso.pdf}

\section{Interpretable Models - Generalized Linear Model}
\includepdf[pages={1-last}]{slides-im-glm.pdf}

\section{Interpretable Models - Some Non-Linear Models}
\includepdf[pages={1-last}]{slides-im-nonlinear.pdf}

\section{Interpretable Models - Model-based Boosting}
\includepdf[pages={1-last}]{slides-im-compboost.pdf}
\end{document}
