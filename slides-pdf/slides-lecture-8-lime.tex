...
\includepdf[pages={1-last}]{slides01-le-intro.pdf}

\section{LIME - Basic Idea}
\includepdf[pages={1-last}]{slides04-le-lime.pdf}

\section{LIME - Example}
\includepdf[pages={1-last}]{slides05-le-lime-examples.pdf}

\section{LIME - Pitfalls}
\includepdf[pages={1-last}]{slides06-le-lime-pitfalls.pdf}
